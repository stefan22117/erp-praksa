<table id="background-table" cellpadding="0" cellspacing="0" border="0" width="100%">
    ...
    <tbody><tr height="40px">
        ...
        <td class="w325" align="left" valign="middle" width="350">
           Dodat je novi komentar na Feedback
        </td>
                            ...
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <div class="article-content" align="left">
                                        <multiline label="Description"><b>Komentar dodao:</b> <?php echo $data['FeedbackComment']['name']; ?></multiline>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table class="w580" cellpadding="0" cellspacing="0" border="0" width="580">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <b>Feedback:</b><br/>
                                    <div class="article-content" align="left">
                                        <multiline label="Description"><i><?php echo $data['FeedbackComment']['feedback']; ?></i></multiline>
                                    </div>
                                </td>
                            </tr>
                            <tr><td class="w580" height="10" width="580"></td></tr>
                    ...
                    <layout label="Text only">
                        <table class="w580" cellpadding="0" cellspacing="0" border="0" width="580">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <div class="article-content" align="left">
                                        <multiline label="Description"><b>Feedback dodao:</b> <?php echo $data['FeedbackComment']['feedback_creator']; ?></multiline>
                                    </div>
                                </td>
                            </tr>
                            <tr><td class="w580" height="10" width="580"></td></tr>
                        ...
                        <table class="w580" cellpadding="0" cellspacing="0" border="0" width="580">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <b>Komentar:</b><br/>
                                    <div class="article-content" align="left">
                                        <multiline label="Description"><?php echo $data['FeedbackComment']['comment']; ?></multiline>
                                        <br/>
                                        <br/>
                                        <multiline label="Description" style="text-decoration:underline;">
                                        <a href="http://www.mikroe.com/erp/process/Feedbacks/view/<?php echo $data['FeedbackComment']['feedback_id']; ?>" style="color:blue;">Pogledajte komentar</a>
                                        </multiline>
                                    </div>
                                </td>
                            </tr>
