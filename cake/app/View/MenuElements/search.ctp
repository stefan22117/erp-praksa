<?php $this->Paginator->options(array('update' => '#container', 'evalScripts' => true, 'before' => '$(".submit_loader").show();', 'success' => 'history.pushState(null, "MikroERP - List menu elements", this.url); $(document).attr("title", "MikroERP - List menu elements");')); ?>
...
<ul class="breadcrumbs">
    ...
    <li><?php echo $this->Js->link('Menu elements', array('controller' => 'MenuElements', 'action' => 'index'), array('update' => '#container', 'buffer' => false, 'success' => 'history.pushState(null, "MikroERP - List menu elements", this.url); $(document).attr("title", "MikroERP - List menu elements");')); ?></li>
