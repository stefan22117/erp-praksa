    ...
    <div id="addNewMaintenanceForm" <?php echo isset($errors['Maintenances']) ? 'style="display: block"' : 'style="display: none"'; ?>>
        ...
        <div class="formular">
            ...
            <div class="col_9">
                ...
                <?php echo $this->Form->date('VmCrossedKm.report_datetime', array('label' => false, 'class' => 'col_9', 'style' => 'margin: 0; width: 100%;', 'value' => $vm_damage['VmDamage']['date'])); ?>
            ...
            <div class="col_9">
                ...
                <?php echo $this->Form->input('VmMaintenance.vm_company_id', array('id' => 'VmCrossedKmVmCompanyIdVmMaintenance', 'label' => false, 'options' => $vm_companies, 'class' => 'col_12', 'style' => 'margin: 0; width: 100%;', 'empty' => __('Izaberite firmu'))); ?>
            </div>
