...
<div class="name_of_page">
    <h3><i class="icon-wrench"></i> <i class="icon-truck"></i> <?php echo __('Popravke vozila: ' . $vm_damage['VmVehicle']['brand_and_model']); ?></h3>
...
<div class="content_data" id="addNewRepairForm" <?php echo isset($errors['Repairs']) ? 'style="display: block"' : 'style="display: none"' ?>>
    <div class="formular">
        ...
        <?php echo $this->Form->hidden('vm_vehicle_id', ['value' => $vm_damage['VmVehicle']['id']]); ?>
        ...
        <?php if ($this->Form->isFieldError('VmRepair.spent_time')) {
            echo $this->Form->error('VmRepair.spent_time');
        } ?>
