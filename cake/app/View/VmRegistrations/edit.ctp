...
<ul class="breadcrumbs">
    ...
    <li class="last"><a href="" onclick="return false"><?php echo __('Izmena'); ?></a></li>
</ul>
...
<div class="name_add_search">
    <div class="name_of_page">
        <h3><i class="icon-file"></i> <?php
                                        
                                        echo __('Izmena postojeće registracije') . '-' . $vm_registration['VmVehicle']['brand_and_model']; ?></h3>
    </div>
</div>
...
<div class="content_data">
    <div class="formular">
        ...
        <div class="col_9" style="display: flex;justify-content: space-between">
            ...
            $days = range(0, 30); $days[0] = __('dani');
            ...
            $hours = range(0, 23); $hours[0] = __('sati');
            echo $this->Form->input('spent_time', [
            ...
            $minutes = range(0, 59); $minutes[0] = __('minuti');
            echo $this->Form->input('spent_time', [
        ...
        <div class="col_9">
            ...
            <?php echo $this->Form->date('expiration_date', array('label' => false, 'class' => 'col_9', 'style' => 'margin: 0; width: 100%;', 'required' => false, 'value' => date("Y-m-d", mktime(0, 0, 0, date('d'), date('m'), date('Y') + 1)), 'placeholder' => __('Unesite kad je vozilo registrovano'))); ?>
...
<script>
    $('#backId').click(function(e) {
        //moze da se dodje iz vmVehicles/view/n i iz vmRegistrations/add 
        e.preventDefault();
