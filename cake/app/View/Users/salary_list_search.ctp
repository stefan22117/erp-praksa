<ul class="breadcrumbs">
    ...
    <li class="last"><a href="" onclick="return false">Rezultati pretrage</a></li>
</ul>
<div id='alert'><?php echo $this->Session->flash(); ?></div>

<div class="name_add_search">
    <div class="name_of_page"><h3>Rezultati pretrage</h3></div>
...
<?php if(empty($users)){ ?>
        <div class="notice warning">
                <i class="icon-warning-sign icon-large"></i>
                    Nema rezultata pretrage po zadatim kriterijumima.
            </div>
<?php }else{ ?>
<table>
    <tr>
