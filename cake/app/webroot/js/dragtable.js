/*
  ...
  Instructions:
    ...
    - Add class="draggable1" to any table you might like to reorder.
  ...
  This is code was based on:
    ...
    - Mike Hall's draggable1 class (http://www.brainjar.com/dhtml/drag/)
    - A discussion of permuting table columns on comp.lang.javascript

  Licensed under the MIT license.
 */

// Here's the notice from Mike Hall's draggable1 script:
//*****************************************************************************
...
dragtable = {
  ...
  // Detect all draggable1 tables and attach handlers to their headers.
  init: function() {
    ...
    forEach(document.getElementsByTagName('table'), function(table) {
      if (table.className.search(/\bdraggable1\b/) != -1) {
        dragtable.makeDraggable1(table);
      }
    });
  },

  // The thead business is taken straight from sorttable.
  makeDraggable1: function(table) {
 ...
 absolutePosition: function(elt, stopAtRelative) {
  ...
  dragStart: function(event, id) {
    ...
    dragObj.elStartLeft  = parseInt(dragObj.cursorStartX, 0);
    dragObj.elStartTop   = parseInt(dragObj.cursorStartY-50,  0);
  ...
  /*setRelAttr: function(){
    var count = 0;
    $("#procurementPlanItems th").each(function() {
      $(this).attr('rel', count);
      count++;
    });
  }*/
