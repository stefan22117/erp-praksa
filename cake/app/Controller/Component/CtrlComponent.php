...
class CtrlComponent extends Component {
    ...
    public function get() {
        ...
        foreach ($aCtrlClasses as $controller) {
            if ($controller != 'AppController') {
                // Load the controller
                App::import('Controller', rtrim($controller, 'Controller'));
    ...
    /**
     * Return an array of selected Controller and his methods.
     * The function will exclude ApplicationController methods
     * @return array
     */
    public function getControllerByName($name) {
        $result_controller = array();
        ...
        foreach ($aCtrlClasses as $controller) {
            if ($controller != 'AppController') {
                ...
                if($name == $controller){
                    $result_controller['name'] = $controller;
                    $result_controller['methods'] = array_diff($aMethods, $parentActions);
                    break;
                }                
            }
        }
