...
class VmRepairsController  extends AppController
{
    ...
    public function add($vm_vehicle_id = null)
    {
        ...
        if ($this->request->is('post')) {
            ...
            $this->request->data['VmRepair']['spent_time'] =
            ...
            if ($this->VmRepair->saveAll($this->request->data)) {

                $this->Session->setFlash('Uspesno ste dodali popravku', 'flash_success');
            } else {
                ...
                $this->Session->write(
                    'errors.VmRepair',
                    $this->VmRepair->validationErrors
                );
                $this->Session->write(
                    'errors.VmCrossedKm',
    ...
    public function save($vm_repair_id = null)
    {
        ...
        if ($this->request->is('ajax')) {
            ...
            $vm_repair['VmCrossedKm']['vm_vehicle_id'] = 
            isset($vm_damage['VmDamage']['vm_vehicle_id'])
            ? $vm_damage['VmDamage']['vm_vehicle_id']: 0;
    ...
    public function delete($vm_repair_id = null)
    {
        ...
        $vm_repair = $this->VmRepair->findById($vm_repair_id);
        if (!$vm_repair) {
            $this->Session->setFlash('Nema izabrane popravke', 'flash_error');
        } else {
